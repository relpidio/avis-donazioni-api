...
class NotificationsSubscribePostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["device_token", "platform", "preferences"]
    ...
    def platform_validate_enum(cls, value):
        ...
        if value not in ('ios', 'android',):
            raise ValueError("must be one of enum values ('ios', 'android')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NotificationsSubscribePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NotificationsSubscribePostRequest from a dict"""
        if obj is None:
            return None
