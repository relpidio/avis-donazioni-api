...
class Center(BaseModel):
    ...
    opening_hours: Optional[StrictStr] = None
    donation_types: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "address", "lat", "lng", "phone", "opening_hours", "donation_types"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of Center from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of Center from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "donation_types": obj.get("donation_types")
        })
        return _obj
