...
class DonationRecord(BaseModel):
    ...
    DonationRecord
    """ # noqa: E501
    donation_id: Optional[StrictStr] = None
    var_date: Optional[date] = Field(default=None, alias="date")
    type: Optional[StrictStr] = None
    center_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["donation_id", "date", "type", "center_id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DonationRecord from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DonationRecord from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "donation_id": obj.get("donation_id"),
            "date": obj.get("date"),
            "type": obj.get("type"),
