...
class DonorUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["phone", "email", "gdpr_consent"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DonorUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DonorUpdate from a dict"""
        if obj is None:
            return None
